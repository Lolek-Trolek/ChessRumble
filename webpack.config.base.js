...
const DEVELOPMENT_API_BASE_URL = 'https://chessrumble.azurewebsites.net'; // base URL of your local API. Use /api if you want to use webpack proxy, else use http://localhost:3000 (frontend origin http://localhost:8080 shall then be authorized by the API cors)
